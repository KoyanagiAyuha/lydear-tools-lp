...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      '各ツールは、可能な限りお使いのブラウザ内でファイルを処理する設計を採用しています。たとえば公開中の shiyosho（Office to Markdown 変換ツール）では、ファイルがサーバーに送信されることはなく、すべての変換処理がお使いのブラウザ内で完結します。',
  },
  {
  ...
  {
    question: 'どんなツールが公開されていますか？',
    answer:
      '現在は、Word・Excel・PowerPoint・CSV を Markdown に変換できる「shiyosho」を公開中です。今後も、ファイル変換やドキュメント整形など、日々の作業に役立つツールを順次追加していく予定です。',
  },
  {
