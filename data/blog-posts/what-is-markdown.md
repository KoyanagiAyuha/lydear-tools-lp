...
Lydear Toolsでは、Word・Excel・PowerPoint・CSV を Markdown に変換できるツール「[shiyosho](https://shiyosho.lydear-tools.com/ja)」を公開しています。まずは手元の資料を変換してみることで、Markdownがどんなものか感覚をつかむことができます。
